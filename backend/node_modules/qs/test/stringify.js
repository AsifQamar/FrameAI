...
test('stringify()', function (t) {
    t.test('stringifies a querystring object', function (st) {
        ...
        st.equal(qs.stringify({ a: 'Ã¢â€šÂ¬' }), 'a=%E2%82%AC');
        st.equal(qs.stringify({ a: 'Ã®â‚¬â‚¬' }), 'a=%EE%80%80');
        st.equal(qs.stringify({ a: 'Ã—Â' }), 'a=%D7%90');
        st.equal(qs.stringify({ a: 'Ã°ÂÂÂ·' }), 'a=%F0%90%90%B7');
        st.end();
    });
    ...
    t.test('can stringify with custom encoding', function (st) {
        st.equal(qs.stringify({ Ã§Å“Å’: 'Ã¥Â¤Â§Ã©ËœÂªÃ¥ÂºÅ“', '': '' }, {
